...
const homePage = new PageContentGenerator("Gyro Paradise", homepageContent);
...
// pageRenderer.renderPageContent(menu.generatePageContent());
...
// pageRenderer.renderPageContent(about.generatePageContent());